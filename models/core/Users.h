...
class Users
{
  public:
    ...
    /**  For column auth_type  */
    ///Get the value of the column auth_type, returns the default value if the column is null
    const std::string &getValueOfAuthType() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getAuthType() const noexcept;
    ///Set the value of the column auth_type
    void setAuthType(const std::string &pAuthType) noexcept;
    void setAuthType(std::string &&pAuthType) noexcept;
  ...
  private:
    ...
    std::shared_ptr<std::string> authType_;
