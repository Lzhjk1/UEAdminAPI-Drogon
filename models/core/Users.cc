...
const std::string Users::Cols::_auth_type = "\"auth_type\"";
...
{"username","std::string","character varying",128,0,0,1},
{"display_name","std::string","character varying",256,0,0,1},
{"auth_type","std::string","character varying",32,0,0,1},
{"password_hash","std::string","character varying",256,0,0,0},
{"email","std::string","character varying",256,0,0,0},
...
{"last_login_at","::trantor::Date","timestamp without time zone",0,0,0,0}
};
...
Users::Users(const Row &r, const ssize_t indexOffset) noexcept
{
    if(indexOffset < 0)
    {
        ...
        if(!r["auth_type"].isNull())
        {
            authType_=std::make_shared<std::string>(r["auth_type"].as<std::string>());
        }
    ...
    else
    {
        ...
        if(!r[index].isNull())
        {
            authType_=std::make_shared<std::string>(r[index].as<std::string>());
        }
        index = offset + 4;
        if(!r[index].isNull())
        {
...
Users::Users(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false)
{
    ...
    if(!pMasqueradingVector[3].empty() && pJson.isMember(pMasqueradingVector[3]))
    {
        ...
        {
            authType_=std::make_shared<std::string>(pJson[pMasqueradingVector[3]].asString());
        }
    }
    ...
    if(!pMasqueradingVector[7].empty() && pJson.isMember(pMasqueradingVector[7]))
    {
        ...
        {
            isAdmin_=std::make_shared<bool>(pJson[pMasqueradingVector[7]].asBool());
        }
    }
...
Users::Users(const Json::Value &pJson) noexcept(false)
{
    ...
    if(pJson.isMember("auth_type"))
    {
        dirtyFlag_[3]=true;
        if(!pJson["auth_type"].isNull())
        {
            authType_=std::make_shared<std::string>(pJson["auth_type"].asString());
        }
    }
...
const std::string &Users::getValueOfAuthType() const noexcept
{
    static const std::string defaultValue = std::string();
    if(authType_)
        return *authType_;
...
const std::shared_ptr<std::string> &Users::getAuthType() const noexcept
{
    return authType_;
}
void Users::setAuthType(const std::string &pAuthType) noexcept
{
    authType_ = std::make_shared<std::string>(pAuthType);
    dirtyFlag_[3] = true;
}
void Users::setAuthType(std::string &&pAuthType) noexcept
{
    authType_ = std::make_shared<std::string>(std::move(pAuthType));
    dirtyFlag_[3] = true;
}
...
Json::Value Users::toJson() const
{
    ...
    if(getAuthType())
    {
        ret["auth_type"]=getValueOfAuthType();
    }
    else
    {
        ret["auth_type"]=Json::Value();
    }
    if(getPasswordHash())
    {
    ...
    const std::vector<std::string> &pMasqueradingVector) const
{
    ...
    if(pMasqueradingVector.size() == 11)
    {
        ...
        if(!pMasqueradingVector[3].empty())
        {
            if(getAuthType())
            {
                ret[pMasqueradingVector[3]]=getValueOfAuthType();
            }
            else
            {
        ...
        if(!pMasqueradingVector[7].empty())
        {
            if(getIsAdmin())
            {
                ret[pMasqueradingVector[7]]=getValueOfIsAdmin();
            }
            else
            {
        ...
        if(!pMasqueradingVector[10].empty())
        {
            if(getLastLoginAt())
            {
                ret[pMasqueradingVector[10]]=getLastLoginAt()->toDbStringLocal();
            }
            else
            {
...
bool Users::validateJsonForCreation(const Json::Value &pJson, std::string &err)
{
    ...
    if(pJson.isMember("auth_type"))
    {
        if(!validJsonOfField(3, "auth_type", pJson["auth_type"], err, true))
            return false;
    }
    if(pJson.isMember("password_hash"))
    {
    ...
    if(pJson.isMember("is_admin"))
    {
        if(!validJsonOfField(7, "is_admin", pJson["is_admin"], err, true))
            return false;
    }
    if(pJson.isMember("created_at"))
    {
    ...
    if(pJson.isMember("last_login_at"))
    {
        if(!validJsonOfField(10, "last_login_at", pJson["last_login_at"], err, true))
            return false;
    }
    return true;
}
...
bool Users::validateJsonForUpdate(const Json::Value &pJson, std::string &err)
{
    ...
    if(pJson.isMember("auth_type"))
    {
        if(!validJsonOfField(3, "auth_type", pJson["auth_type"], err, false))
            return false;
    }
    if(pJson.isMember("password_hash"))
    {
    ...
    if(pJson.isMember("is_admin"))
    {
        if(!validJsonOfField(7, "is_admin", pJson["is_admin"], err, false))
            return false;
    }
    if(pJson.isMember("created_at"))
    {
    ...
    if(pJson.isMember("last_login_at"))
    {
        if(!validJsonOfField(10, "last_login_at", pJson["last_login_at"], err, false))
            return false;
    }
    return true;
}
