...
class UserFlashtoken
{
  public:
    struct Cols
    {
        ...
        static const std::string _flash_token;
     ...
     */
    explicit UserFlashtoken(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit UserFlashtoken(const Json::Value &pJson) noexcept(false);
     ...
     */
    UserFlashtoken(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    UserFlashtoken() = default;
    ...
    /**  For column flash_token  */
    ///Get the value of the column flash_token, returns the default value if the column is null
    const std::string &getValueOfFlashToken() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getFlashToken() const noexcept;
    ...
    const std::string &getValueOfTokenDesc() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getTokenDesc() const noexcept;
  ...
  private:
    friend drogon::orm::Mapper<UserFlashtoken>;
    friend drogon::orm::BaseBuilder<UserFlashtoken, true, true>;
    friend drogon::orm::BaseBuilder<UserFlashtoken, true, false>;
    friend drogon::orm::BaseBuilder<UserFlashtoken, false, true>;
    friend drogon::orm::BaseBuilder<UserFlashtoken, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<UserFlashtoken>;
#endif
    ...
    std::shared_ptr<std::string> flashToken_;
