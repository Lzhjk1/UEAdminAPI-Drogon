...
class User
{
  public:
    ...
    void getUser_gitlab_info(const drogon::orm::DbClientPtr &clientPtr,
                             const std::function<void(UserGitlabInfo)> &rcb,
                             const drogon::orm::ExceptionCallback &ecb) const;
    UserFlashtoken getUser_flashtoken(const drogon::orm::DbClientPtr &clientPtr) const;
    void getUser_flashtoken(const drogon::orm::DbClientPtr &clientPtr,
                            const std::function<void(UserFlashtoken)> &rcb,
                            const drogon::orm::ExceptionCallback &ecb) const;
    std::vector<std::pair<ThirdPartyPlatforms,UserThirdPartyInfo>> getThird_party_platforms(const drogon::orm::DbClientPtr &clientPtr) const;
    void getThird_party_platforms(const drogon::orm::DbClientPtr &clientPtr,
