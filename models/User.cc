...
const std::string User::Cols::_password_salt = "\"password_salt\"";
const std::string User::Cols::_password_hash = "\"password_hash\"";
const std::string User::Cols::_privilege = "\"privilege\"";
const std::string User::Cols::_nick_name = "\"nick_name\"";
const std::string User::Cols::_telephone_number = "\"telephone_number\"";
const std::string User::Cols::_email = "\"email\"";
const std::string User::Cols::_is_male = "\"is_male\"";
const std::string User::Cols::_create_at = "\"create_at\"";
...
{"telephone_number","std::string","character varying",20,0,0,0},
...
const std::vector<char> &User::getValueOfPasswordSalt() const noexcept
{
...
std::string User::getValueOfPasswordSaltAsString() const noexcept
{
    static const std::string defaultValue = std::string();
    if(passwordSalt_)
...
const std::shared_ptr<std::vector<char>> &User::getPasswordSalt() const noexcept
{
    return passwordSalt_;
}
void User::setPasswordSalt(const std::vector<char> &pPasswordSalt) noexcept
{
    passwordSalt_ = std::make_shared<std::vector<char>>(pPasswordSalt);
    dirtyFlag_[2] = true;
}
void User::setPasswordSalt(const std::string &pPasswordSalt) noexcept
{
    passwordSalt_ = std::make_shared<std::vector<char>>(pPasswordSalt.c_str(),pPasswordSalt.c_str()+pPasswordSalt.length());
    dirtyFlag_[2] = true;
}

const std::vector<char> &User::getValueOfPasswordHash() const noexcept
{
    static const std::vector<char> defaultValue = std::vector<char>();
    if(passwordHash_)
...
std::string User::getValueOfPasswordHashAsString() const noexcept
{
    static const std::string defaultValue = std::string();
    if(passwordHash_)
...
const std::shared_ptr<std::vector<char>> &User::getPasswordHash() const noexcept
{
    return passwordHash_;
}
void User::setPasswordHash(const std::vector<char> &pPasswordHash) noexcept
{
...
const int32_t &User::getValueOfPrivilege() const noexcept
{
    static const int32_t defaultValue = int32_t();
    if(privilege_)
        return *privilege_;
...
const std::shared_ptr<int32_t> &User::getPrivilege() const noexcept
{
    return privilege_;
}
void User::setPrivilege(const int32_t &pPrivilege) noexcept
{
...
const std::string &User::getValueOfTelephoneNumber() const noexcept
{
    static const std::string defaultValue = std::string();
    if(telephoneNumber_)
...
const std::shared_ptr<std::string> &User::getTelephoneNumber() const noexcept
{
    return telephoneNumber_;
}
void User::setTelephoneNumber(const std::string &pTelephoneNumber) noexcept
{
    telephoneNumber_ = std::make_shared<std::string>(pTelephoneNumber);
    dirtyFlag_[6] = true;
}
void User::setTelephoneNumber(std::string &&pTelephoneNumber) noexcept
{
    telephoneNumber_ = std::make_shared<std::string>(std::move(pTelephoneNumber));
    dirtyFlag_[6] = true;
}
void User::setTelephoneNumberToNull() noexcept
{
...
const bool &User::getValueOfIsMale() const noexcept
{
...
const std::shared_ptr<bool> &User::getIsMale() const noexcept
{
    return isMale_;
}
void User::setIsMale(const bool &pIsMale) noexcept
{
    isMale_ = std::make_shared<bool>(pIsMale);
    dirtyFlag_[8] = true;
}

const ::trantor::Date &User::getValueOfCreateAt() const noexcept
{
...
const std::shared_ptr<::trantor::Date> &User::getCreateAt() const noexcept
{
    return createAt_;
}
void User::setCreateAt(const ::trantor::Date &pCreateAt) noexcept
{
...
bool User::validateJsonForCreation(const Json::Value &pJson, std::string &err)
{
    ...
    if(pJson.isMember("nick_name"))
    {
        if(!validJsonOfField(5, "nick_name", pJson["nick_name"], err, true))
            return false;
    }
    else
    {
...
bool User::validateJsonForUpdate(const Json::Value &pJson, std::string &err)
{
    ...
    if(pJson.isMember("nick_name"))
    {
        if(!validJsonOfField(5, "nick_name", pJson["nick_name"], err, false))
            return false;
    }
    if(pJson.isMember("telephone_number"))
    {
...
UserGitlabInfo User::getUser_gitlab_info(const DbClientPtr &clientPtr) const {
    static const std::string sql = "select * from user_gitlab_info where user_id = $1";
    Result r(nullptr);
    {
    ...
    return UserGitlabInfo(r[0]);
}

void User::getUser_gitlab_info(const DbClientPtr &clientPtr,
                               const std::function<void(UserGitlabInfo)> &rcb,
                               const ExceptionCallback &ecb) const
{
    ...
    *clientPtr << sql
               ...
               >> [rcb = std::move(rcb), ecb](const Result &r){
                    ...
                    {
                        rcb(UserGitlabInfo(r[0]));
                    }
               }
               >> ecb;
}
UserFlashtoken User::getUser_flashtoken(const DbClientPtr &clientPtr) const {
    static const std::string sql = "select * from user_flashtoken where user_id = $1";
    Result r(nullptr);
    {
        auto binder = *clientPtr << sql;
        binder << *id_ << Mode::Blocking >>
    ...
    return UserFlashtoken(r[0]);
}

void User::getUser_flashtoken(const DbClientPtr &clientPtr,
                              const std::function<void(UserFlashtoken)> &rcb,
                              const ExceptionCallback &ecb) const
{
    static const std::string sql = "select * from user_flashtoken where user_id = $1";
    *clientPtr << sql
               ...
               >> [rcb = std::move(rcb), ecb](const Result &r){
                    ...
                    {
                        rcb(UserFlashtoken(r[0]));
                    }
               }
               >> ecb;
}
std::vector<std::pair<ThirdPartyPlatforms,UserThirdPartyInfo>> User::getThird_party_platforms(const DbClientPtr &clientPtr) const {
    static const std::string sql = "select * from third_party_platforms,user_third_party_info where user_third_party_info.user_id = $1 and user_third_party_info.platform_id = third_party_platforms.id";
    Result r(nullptr);
    {
        auto binder = *clientPtr << sql;
        binder << *id_ << Mode::Blocking >>
    ...
    std::vector<std::pair<ThirdPartyPlatforms,UserThirdPartyInfo>> ret;
    ret.reserve(r.size());
    for (auto const &row : r)
    {
        ret.emplace_back(std::pair<ThirdPartyPlatforms,UserThirdPartyInfo>(
            ThirdPartyPlatforms(row),UserThirdPartyInfo(row,ThirdPartyPlatforms::getColumnNumber())));
    }
    return ret;
}

void User::getThird_party_platforms(const DbClientPtr &clientPtr,
                                    const std::function<void(std::vector<std::pair<ThirdPartyPlatforms,UserThirdPartyInfo>>)> &rcb,
                                    const ExceptionCallback &ecb) const
{
    static const std::string sql = "select * from third_party_platforms,user_third_party_info where user_third_party_info.user_id = $1 and user_third_party_info.platform_id = third_party_platforms.id";
    *clientPtr << sql
